    ...
    <header class="sidebar" id="sidebar">
        <nav class="navbar">
            ...
            <div class="nav-links">
                ...
                <a href="report.php" class="active"><img src="styles/images/report.png" alt=""><span>Report</span></a>
        ...
        <section class="content">
            <form class="report-form" id="reportForm" action="php/export.php" method="POST">
                <header class="form-header">
                    ...
                    <p>Select table, date range, and column parameters to generate data reports.</p>
                </header>
                    ...
                    <div class="checkbox-wrapper">
                        <div class="checkbox-header">
                            <span class="checkbox-title">
                                <i class="fa-solid fa-list-check"></i> Select Columns to Export
                            </span>
                        </div>
                        <div id="checkboxes" class="checkbox-grid"></div>
                    </div>
                </div>
